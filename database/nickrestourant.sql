...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1020500447ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=nickrestourant&table=customer">`nickrestourant`.`customer`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=nickrestourant&table=payment">`nickrestourant`.`payment`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=nickrestourant&table=store">`nickrestourant`.`store`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=nickrestourant&table=ordert">`nickrestourant`.`ordert`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=nickrestourant&table=manager">`nickrestourant`.`manager`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=nickrestourant&table=foodinfo">`nickrestourant`.`foodinfo`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=nickrestourant&table=derivary">`nickrestourant`.`derivary`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=reg_db&table=orders">`reg_db`.`orders`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=my_db&table=category">`my_db`.`category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=rms&table=tables">`rms`.`tables`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="675f6f2f633d5f7470405e5541236634">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="nickrestourant" targettable="customer">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `nickrestourant`.`customer` ( `cu_id` INT NOT NULL ,  `first_name` VARCHAR(255) NOT NULL ,  `last_name` VARCHAR(255) NOT NULL ,  `email` VARCHAR(25) NOT NULL ,  `adderess` VARCHAR(20) NOT NULL ,  `contact` TEXT NOT NULL ,  `username` VARCHAR(20) NOT NULL ,  `password` VARCHAR(20) NOT NULL ,  `date` TIMESTAMP NOT NULL ) ENGINE = MyISAM;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="nickrestourant" targettable="customer">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `customer` ADD PRIMARY KEY(`cu_id`);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="nickrestourant" targettable="derivary">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `derivary`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="nickrestourant" targettable="foodinfo">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `foodinfo`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="nickrestourant" targettable="manager">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `manager`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="nickrestourant" targettable="ordert">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `ordert`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="nickrestourant" targettable="payment">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `payment`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="nickrestourant" targettable="store">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `store`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="nickrestourant" targettable="payment">
                            <div class="action_content">
